...
describe("Create endpoint", () => {
    it('Duplicate User', async() =>{
        ...
        const mockEvent = createMockEvent({ email: 'testEmail@gmail.com', password: 'testPassword123' },
        '/create',
        'POST');
    ...
    it('Registration time has passed', async() =>{
        ...
        const mockEvent = createMockEvent({ email: 'testEmail@gmail.com', password: 'testPassword123' }, '/create',
        'POST');
        const mockContext = createMockContext();
        const mockCallback = jest.fn();
        const res = await main(mockEvent, mockContext, mockCallback);
